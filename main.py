...
def main(page: ft.Page):
    ...
    page.add(
        ft.Row([ft.Icon(ft.icons.VIDEO_LIBRARY, color=ft.colors.BLUE_700), ft.Text("X Video Downloader App", size=24, weight=ft.FontWeight.BOLD, color=ft.colors.BLUE_700)], alignment=ft.MainAxisAlignment.CENTER),
        ft.Divider(),
